...
import {
  ...
  Plus, Minus, CheckCircle, Truck, RefreshCw,
} from "lucide-react";
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          {product.images?.length > 1 && (
            <div className="flex gap-3 mt-3">
              {product.images.slice(1).map((img: string, i: number) => (
                <div key={i} className="w-20 h-20 rounded-xl overflow-hidden border-2 border-[var(--border)] hover:border-blue-500 transition cursor-pointer">
                  {img.startsWith("http") ? (
        ...
        <div>
          ...
          <div className="flex items-center gap-2 mb-3 flex-wrap">
            ...
            {product.productType && (
              <span className="bg-purple-100 dark:bg-purple-900/40 text-purple-700 dark:text-purple-300 text-xs font-medium px-3 py-1 rounded-full">
          ...
          <div className="text-sm text-gray-500 dark:text-gray-400 mb-4 space-y-1.5">
            {product.author && (
              <p>Author: <span className="text-gray-700 dark:text-gray-300 font-medium">{product.author}</span></p>
            )}
            {product.publisher && (
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            {product.discountPrice && (
              <div>
                <span className="text-lg text-gray-400 line-through block">৳{product.price.toLocaleString()}</span>
          ...
          <div className="flex gap-3 mb-8">
            ...
            <button
              ...
              className={`p-4 rounded-xl border-2 transition ${wishlisted
                ? "border-red-500 bg-red-50 dark:bg-red-900/20 text-red-500"
                : "border-[var(--border)] hover:border-red-300 text-gray-400 hover:text-red-500"
              }`}
            >
          ...
          {/* Delivery Info */}
          <div className="flex gap-6 p-4 bg-[var(--muted)] rounded-xl">
