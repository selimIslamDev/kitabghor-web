...
export default function ProductDetailClient({ id }: { id: string }) {
    ...
    return (
      <div style={theme} className="min-h-screen bg-[var(--bg)]">
        <div className="max-w-[1280px] mx-auto px-7 py-24 text-center">
          ...
          <h2 className="text-2xl font-bold text-[var(--text)] mb-2" style={{ fontFamily: "'Cormorant Garamond', serif" }}>
            Product Not Found
          </h2>
          ...
          <Link
            href="/products"
            className="inline-block px-6 py-3 rounded-[10px] font-semibold text-[#0c0b09]"
            style={{ background: "linear-gradient(135deg, var(--gold) 0%, #b8921f 100%)" }}
          >
            Back to Shop
          </Link>
        </div>
  ...
  return (
    <div style={theme} className="min-h-screen bg-[var(--bg)] text-[var(--text)] relative">
      ...
      <div
        className="max-w-[1280px] mx-auto px-5 sm:px-7 py-8 relative z-[1]"
        style={{ fontFamily: "'Inter', system-ui, sans-serif" }}
      >
        {/* Breadcrumb */}
        <div className="flex items-center gap-2 text-[0.82rem] text-[var(--text-dim)] mb-2">
          <Link href="/" className="text-[var(--text-muted)] hover:text-[var(--gold)] transition">
            Home
          </Link>
          <span className="opacity-60">/</span>
          <Link href="/products" className="text-[var(--text-muted)] hover:text-[var(--gold)] transition">
            Shop
          </Link>
          <span className="opacity-60">/</span>
        ...
        <Link
          href="/products"
          className="inline-flex items-center gap-2 text-xs font-semibold text-[var(--gold-soft)] hover:text-[var(--gold)] hover:gap-3 transition-all my-6 group"
        >
          ...
          <div className="lg:col-span-5">
            ...
            >
              <div
                ...
                style={{
                  background:
                    "radial-gradient(ellipse at 30% 20%, rgba(201, 162, 39, 0.07) 0%, transparent 55%)",
                }}
              />
            ...
            <div
              className="hidden lg:grid grid-cols-2 gap-3 mt-6 p-4 rounded-2xl"
            ...
            >
              {[
                ...
                <div key={idx} className="flex items-center gap-3 p-2">
                  <div
                    className="w-9 h-9 rounded-xl flex items-center justify-center shrink-0 text-[var(--gold)]"
          ...
          <div className="lg:col-span-7 relative flex flex-col justify-between">
            ...
            <div>
              ...
              <div className="flex items-center justify-between gap-4 mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-[0.9rem] text-[var(--text-muted)]">
                    <strong className="text-[var(--text)] font-semibold">{rating}.0</strong> ·{" "}
              ...
              >
                ...
                {product.discountPrice && (
                  <>
                    <span className="text-[1.15rem] text-[var(--text-dim)] line-through">
                      ৳{product.price.toLocaleString()}
                    </span>
                    <span
                      className="text-[0.82rem] font-semibold px-2.5 py-1 rounded-[5px]"
                      style={{ color: "var(--success)", background: "rgba(74, 155, 110, 0.12)" }}
                    >
                ...
                <div className="grid grid-cols-2 gap-x-7 gap-y-3.5 mb-8 text-[0.88rem]">
                  {isValidMeta(product.publisher) && (
                    <div className="flex flex-col gap-[3px]">
                      <span className="text-[0.78rem] uppercase tracking-wide text-[var(--text-dim)]">
                        Publisher
                      </span>
              ...
              <div className="flex items-center gap-3.5 flex-wrap mb-2">
                ...
                >
                  ...
                  <span className="w-11 text-center font-semibold text-sm text-[var(--text)]">
                    {quantity}
                  </span>
                  <button
        ...
        <div className="mb-16 pt-7" style={{ borderTop: "1px solid var(--border)" }}>
          <div className="flex gap-7 mb-6 pb-0" style={{ borderBottom: "1px solid var(--border)" }}>
            {(["description", "specifications", "reviews"] as const).map((tab) => (
              ...
              >
                ...
                {activeTab === tab && (
                  <span
                    className="absolute left-0 right-0 -bottom-px h-[2px] rounded-t-[2px]"
          ...
          {activeTab === "description" && (
            <div>
              <div
                className={`text-[0.95rem] leading-[1.75] text-[var(--text-muted)] ${
          ...
          {activeTab === "specifications" && (
            <div
              className="rounded-[14px] overflow-hidden max-w-2xl"
              style={{ background: "var(--bg-elevated)", border: "1px solid var(--border)" }}
            >
              <table className="w-full text-left text-xs">
                <tbody className="divide-y" style={{ borderColor: "var(--border)" }}>
                  {isValidMeta(product.publisher) && (
                    <tr>
                      <td
                        className="px-6 py-3.5 text-[var(--text-dim)] font-medium w-1/3"
                        style={{ background: "var(--bg-soft)" }}
                      >
                        Publisher
                      </td>
                      <td className="px-6 py-3.5 font-semibold text-[var(--text)]">
                        {product.publisher}
                      </td>
                    </tr>
                  )}
                  {isValidMeta(product.author) && (
                    <tr>
                      <td
                        className="px-6 py-3.5 text-[var(--text-dim)] font-medium"
                        style={{ background: "var(--bg-soft)" }}
                      >
                        Author
                      </td>
                  ...
                  {isValidMeta(product.isbn) && (
                    <tr>
                      ...
                      <td className="px-6 py-3.5 font-semibold text-[var(--text)] font-mono">
                        {product.isbn}
                      </td>
                    </tr>
                  )}
      ...
      {/* Sticky Bar */}
      <div
        className={`fixed bottom-0 left-0 right-0 z-50 p-3 transition-transform duration-300 ${
