...
export default function AuthClient({ defaultTab }: { defaultTab: Tab }) {
  ...
  // 🛠️ ফিক্স: লগইন সফল হওয়ার পর স্টেট সিঙ্কিংয়ের জন্য হার্ড রিফ্রেশ সহ রিডাইরেক্ট
  useEffect(() => {
  ...
  // 🛠️ ফিক্স: রেজিস্ট্রেশন সফল হওয়ার পর স্টেট সিঙ্কিংয়ের জন্য হার্ড রিফ্রেশ সহ রিডাইরেক্ট
  useEffect(() => {
