...
function ItemImage({ image, name }: { image: string; name: string }) {
  ...
  return (
    <div className="w-10 h-10 rounded-xl bg-[var(--muted)] flex-shrink-0 flex items-center justify-center">
                ...
                {paymentMethods.map((method) => (
                  ...
                  >
                    <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${
                      paymentMethod === method.id ? "bg-blue-600 text-white" : "bg-[var(--muted)] text-gray-500"
                    }`}>
                      {method.icon}
                    </div>
