...
function DashboardClientInner({ initialTab }: { initialTab: Tab }) {
  ...
  `}
        >
          {/* User card - redesigned, logic unchanged */}
          <div className="relative overflow-hidden mx-3 mt-3 mb-2 rounded-2xl border border-white/[0.07] bg-[#111720]/95 p-4 text-white shadow-[0_10px_35px_rgba(0,0,0,0.28)]">
            ...
            <div className="pointer-events-none absolute -right-2 bottom-0 h-24 w-24 rounded-full bg-violet-500/10 blur-2xl" />
            <div
              className="pointer-events-none absolute right-[-18px] top-3 h-28 w-28 opacity-[0.16]"
              style={{
                backgroundImage:
                  "radial-gradient(circle at 1px 1px, rgba(56,189,248,0.35) 1px, transparent 0)",
            ...
            <div className="relative flex items-center gap-3">
              {/* Avatar */}
              <div className="relative h-14 w-14 shrink-0 rounded-full p-[2px] bg-gradient-to-br from-fuchsia-500 via-violet-500 to-sky-400 shadow-[0_0_18px_rgba(59,130,246,0.18)]">
                <div className="flex h-full w-full items-center justify-center rounded-full bg-[#182131] ring-1 ring-white/[0.08]">
                  <span className="text-[25px] leading-none">👤</span>
                </div>
              </div>

              <div className="min-w-0 flex-1">
                <p className="font-semibold text-[14px] truncate tracking-tight text-slate-100">
                  {user?.name || "Student"}
                </p>
              ...
              <button
                ...
                className="lg:hidden relative z-[110] p-2 -m-1 rounded-lg text-slate-400 hover:text-white hover:bg-white/[0.06] active:bg-white/[0.1] transition shrink-0 cursor-pointer touch-manipulation"
              >
                <X className="w-4 h-4" />
              </button>
            </div>
