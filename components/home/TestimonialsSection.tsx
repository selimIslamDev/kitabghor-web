...
const testimonials = [
  {
    ...
    rating: 5,
    comment:
      "KitabGhor is amazing! I got all my SSC books and a calculator in one order. Fast delivery and great prices. Highly recommended!",
    avatar: "👦",
  },
  {
    id: 2,
    ...
    rating: 5,
    comment:
      "The HSC Science Pack saved me so much money. All books were original and arrived in perfect condition. Will definitely order again!",
    avatar: "👧",
  },
  {
    id: 3,
    ...
    rating: 4,
    comment:
      "Great collection of university books. Found some rare titles that I couldn't find anywhere else. Customer service is very helpful.",
    avatar: "👨",
  },
  {
    id: 4,
    ...
    rating: 5,
    comment:
      "Ordered the geometry box and pen set combo. Excellent quality products at affordable prices. My go-to shop for stationery!",
    avatar: "👩",
  },
  {
    id: 5,
    ...
    rating: 5,
    comment:
      "Best online bookshop in Bangladesh! The website is easy to use and the checkout process is smooth. Got my books within 2 days.",
    avatar: "👦",
  },
  {
    id: 6,
    ...
    rating: 4,
    comment:
      "Very satisfied with my purchase. The SSC starter pack is great value for money. Books are exactly as described.",
    avatar: "👧",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="text-base text-gray-600 dark:text-gray-400">
            Trusted by thousands of students across Bangladesh for authentic books and fast delivery.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {testimonials.map((t) => (
            <div
              key={t.id}
              className="group bg-white dark:bg-slate-800/90 rounded-2xl border border-gray-100 dark:border-slate-700/60 p-6 shadow-sm hover:shadow-xl hover:border-emerald-500/30 dark:hover:border-emerald-500/30 transition-all duration-300 hover:-translate-y-1 relative flex flex-col justify-between"
            >
              <div>
              ...
              <div className="pt-4 border-t border-gray-50 dark:border-slate-700/40 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-emerald-100 to-blue-100 dark:from-emerald-950 dark:to-slate-800 flex items-center justify-center text-xl border border-emerald-200/50 dark:border-emerald-800/30 shadow-inner">
                    {t.avatar}
                  </div>
                  <div>
